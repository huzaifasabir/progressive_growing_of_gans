...
desc += '-mutual_ex';        dataset = EasyDict(tfrecord_dir='without_refrence_chiristian');        train.mirror_augment = True
...
#train = EasyDict(func='util_scripts.discriminator_evaluation', run_id='071-pgan-mutual_ex-preset-v2-4gpus-fp32'); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
train = EasyDict(func='util_scripts.generate_fake_images', run_id='071-pgan-mutual_ex-preset-v2-4gpus-fp32', num_pngs=500); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
