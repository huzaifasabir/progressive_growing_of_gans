...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id='069-pgan-mutual_ex-preset-v2-1gpu-fp32', num_pngs=500); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
