...
desc += '-4inputs';        dataset = EasyDict(tfrecord_dir='without_refrence_chiristian');        train.mirror_augment = True
...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id='075-pgan-4inputs-preset-v2-2gpus-fp32', num_pngs=500); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
