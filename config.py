...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id='061-pgan-tf50ksorted-preset-v2-4gpus-fp32', num_pngs=500); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
