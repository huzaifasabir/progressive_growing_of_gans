...
env.CUDA_VISIBLE_DEVICES                       = '7'       # Unspecified (default) = Use all available GPUs. List of ints = CUDA device numbers to use.
...
desc += '-specificCat';        dataset = EasyDict(tfrecord_dir='only_childrenbook');        train.mirror_augment = True
...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id='063-pgan-specificCat-preset-v2-1gpu-fp32', num_pngs=500); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
