...
env.CUDA_VISIBLE_DEVICES                       = '4'       # Unspecified (default) = Use all available GPUs. List of ints = CUDA device numbers to use.
...
train = EasyDict(func='util_scripts.generate_fake_images', run_id='047-pgan-tf50ksorted-preset-v2-4gpus-fp32', num_pngs=500); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
