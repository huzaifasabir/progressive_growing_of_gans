...
desc += '-tf50ksorted';        dataset = EasyDict(tfrecord_dir='50k_sorted_tf');        train.mirror_augment = True
...
#train = EasyDict(func='util_scripts.generate_fake_images', run_id='013-pgan-tf50k-preset-v2-2gpus-fp32', num_pngs=32); num_gpus = 1; desc = 'fake-images-' + str(train.run_id)
...
#train = EasyDict(func='util_scripts.generate_interpolation_video', run_id='010-pgan-data50k-preset-v2-4gpus-fp32', grid_size=[1,1], duration_sec=60.0, smoothing_sec=1.0); num_gpus = 1; desc = 'interpolation-video-' + str(train.run_id)
